...
var cssSrc='src/statistics-classification-binary.less';
...
gulp.task('watch',function(){
	...
	gulp.watch(cssSrc,['lib-css']);
});

gulp.task('default',['en-empty-html','ru-empty-html','en-static-html','ru-static-html','lib-js','lib-css']);
